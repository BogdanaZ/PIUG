...
let AccordionBasicComponent = class AccordionBasicComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let NgbdCarouselPauseComponent = class NgbdCarouselPauseComponent {
    constructor() {
        this.images = [1, 2, 3, 4, 5, 6, 7].map(() => `https://picsum.photos/900/500?random&t=${Math.random()}`);
        this.paused = true;
